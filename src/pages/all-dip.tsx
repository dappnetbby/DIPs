...
import { AllDipsQuery } from '../../types/gql'
...
const Template: React.FC<Props> = ({ data: { allMarkdownRemark } }) => {
  ...
  )(group) as AllDipsQuery['allMarkdownRemark']['group']

  return (
    <Main>
      <Helmet title="All DIPs" />
      <header className="post-header">
        <h1 className="post-title">All DIPs</h1>
      </header>
      <div className="post-content">
        {columns.map((g) => {
          const rows = sortBy('frontmatter.dip')(g.nodes)
          return (
